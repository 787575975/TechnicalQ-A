...
public class CommonAPI {
    ...
    public  void initializeTest() {
        ...
        if(getOsNameFromSystem.contains("Mac")){
            System.setProperty("webdriver.chrome.driver", "/Users/dola/IdeaProjects/TechnicalA/driver/chromedriver");
        }else if(getOsNameFromSystem.contains("Windows")){
            System.setProperty("webdriver.chrome.driver", "/Users/dola/IdeaProjects/TechnicalA/driver/chromedriver.exe");
        }
